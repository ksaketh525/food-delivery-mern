    ...
    <div className="min-h-[80vh] flex justify-center items-center px-4 py-12">
      <div className="bg-white p-10 rounded-3xl shadow-xl shadow-gray-200/40 w-full max-w-md border border-gray-100">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-black text-gray-900 mb-2 tracking-tight">Join Us</h2>
        ...
        <form onSubmit={handleRegister} className="space-y-5">
          <div>
            ...
            <input 
              ...
              value={name} onChange={(e) => setName(e.target.value)} placeholder="Bobby" required 
            />
          </div>
          ...
          <div>
            ...
            <input 
              type="email" 
              className="w-full px-5 py-3.5 bg-gray-50 border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-brand/20 focus:border-brand transition-all font-medium" 
              value={email} onChange={(e) => setEmail(e.target.value)} placeholder="user@gmail.com" required 
            />
          </div>
        ...
        <p className="text-center mt-8 text-gray-500 font-medium">
          Already have an account? <Link to="/login" className="text-brand hover:text-brandDark font-bold ml-1">Sign in</Link>
        </p>
      </div>
    </div>
  );
